      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Manage your uploaded Excel and
            spreadsheet files
          </p>
        </div>
            ...
            {workbooks.map(
              (wb) => {
                ...
                return (
                  <div
                    key={wb.id}
                    className={`group relative rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-400 hover:shadow-md dark:border-gray-700 dark:bg-gray-900 ${
                      isDeleting
